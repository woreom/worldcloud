...
def make_wordcloud(font_path=None,text_path='tweets/result.txt',bw_img="input/southpark1.png",img="input/southpark2.png", add_stopwords=ADD_STOPWORDS, bg_color='black', include_numbers=True, max_words=500, random_color=False):
...
if __name__ == '__main__':
    make_wordcloud(font_path=None,max_words=10**10, random_color=False, bg_color='black', include_numbers=True, text_path='tweets/woreom.txt',bw_img="input/southpark.png",img="input/southpark.png", add_stopwords=ADD_STOPWORDS)
